...
class BanditAlgo:
    ...
    def update(self, reward, arm): 
        ...
        :param arm: An int (0 <= arm < self.K) corresponding to which
...
if __name__ == '__main__':
    ...
    We iteratre over the timesteps giving you the 
    reward at the arms your implementation chooses.
    From this we calculate the total reward and regret.
    """
    rewards = np.genfromtxt('data/mab_ec_arm_data.txt', dtype=int)
    ...
    print("Your regret is: " + str(800 - total_reward))
